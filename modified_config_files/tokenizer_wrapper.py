...
def tokenize(args):
  ...
  with open(input_file1, 'r',encoding="utf-8") as file1, open(input_file2, 'r',encoding="utf-8") as file2:
    with open(tokenized_output1, 'w',encoding="utf-8") as ofile1, open(tokenized_output2, 'w',encoding="utf-8") as ofile2:
      while True: # YaY!
...
def encode(args):
  ...
  with open(input_file1, 'r',encoding="utf-8") as file1:
    with open(tokenized_output1, 'w',encoding="utf-8") as ofile1:
      while True: # YaY!
        _src_raw = file1.readline()
        if not _src_raw:
          break
